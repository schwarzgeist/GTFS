...
void FeedHeader::set_gtfs_realtime_version(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000001u;
 gtfs_realtime_version_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void FeedHeader::_internal_set_gtfs_realtime_version(const std::string& value) {
  _has_bits_[0] |= 0x00000001u;
  gtfs_realtime_version_.Set(value, GetArenaForAllocation());
}
inline std::string* FeedHeader::_internal_mutable_gtfs_realtime_version() {
  _has_bits_[0] |= 0x00000001u;
  return gtfs_realtime_version_.Mutable(GetArenaForAllocation());
}
inline std::string* FeedHeader::release_gtfs_realtime_version() {
  ...
  _has_bits_[0] &= ~0x00000001u;
  auto* p = gtfs_realtime_version_.Release();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (gtfs_realtime_version_.IsDefault()) {
...
inline void FeedHeader::set_allocated_gtfs_realtime_version(std::string* gtfs_realtime_version) {
  ...
  gtfs_realtime_version_.SetAllocated(gtfs_realtime_version, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (gtfs_realtime_version_.IsDefault()) {
    gtfs_realtime_version_.Set("", GetArenaForAllocation());
  }
...
void VehicleDescriptor::set_license_plate(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000004u;
 license_plate_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void VehicleDescriptor::_internal_set_license_plate(const std::string& value) {
  _has_bits_[0] |= 0x00000004u;
  license_plate_.Set(value, GetArenaForAllocation());
}
inline std::string* VehicleDescriptor::_internal_mutable_license_plate() {
  _has_bits_[0] |= 0x00000004u;
  return license_plate_.Mutable(GetArenaForAllocation());
}
inline std::string* VehicleDescriptor::release_license_plate() {
  ...
  _has_bits_[0] &= ~0x00000004u;
  auto* p = license_plate_.Release();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (license_plate_.IsDefault()) {
...
inline void VehicleDescriptor::set_allocated_license_plate(std::string* license_plate) {
  ...
  license_plate_.SetAllocated(license_plate, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (license_plate_.IsDefault()) {
    license_plate_.Set("", GetArenaForAllocation());
  }
